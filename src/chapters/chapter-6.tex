...
keretrendszer felhasználói kénytelenek lettek volna harmadik féltől származó szoftvereket alkalmazni. Vagy az
\textit{SQLite} adatbázis megnyitásához, és lekérdezéséhez, vagy a \textit{JUnit XML} vizualizálásához.
...
\section{A \textit{HTMLReporter} komponens}
    ...
    A \textit{HTMLReporter} komponens strukturáltan prezentálja az információt a felhasználó felé. A struktúra egy fába
    van rendezve.
    ...
    \textit{STDERR-re}, valamint egy konfigurációs fájl amivel reprodukálni lehet a bukást. A mellékletekben található
